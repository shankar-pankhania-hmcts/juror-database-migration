...
SELECT
    ...
    J.SUPER_URGENT,
    J.WELSH,
    CASE WHEN WL.LOC_CODE IS NULL THEN 'N' ELSE 'Y' END AS WELSH_COURT
FROM
    JUROR_DETAILS_CTE J
INNER JOIN
...
LEFT OUTER JOIN
	JUROR.WELSH_LOCATION WL
ON
	C.LOC_CODE = WL.LOC_CODE;
