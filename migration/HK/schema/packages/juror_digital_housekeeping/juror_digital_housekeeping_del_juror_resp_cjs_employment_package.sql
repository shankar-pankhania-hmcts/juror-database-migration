...
-- =================================================================================================
-- =================================================================================================
CREATE OR REPLACE PROCEDURE hk.juror_digital_housekeeping_del_juror_resp_cjs_employment (juror_no text, completed_date timestamp(0), INOUT lb_failed bool) AS $body$
DECLARE
ora2pg_rowcount int;
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE hk.juror_digital_housekeeping_del_juror_resp_cjs_employment (juror_no text, completed_date timestamp(0)) FROM PUBLIC;
