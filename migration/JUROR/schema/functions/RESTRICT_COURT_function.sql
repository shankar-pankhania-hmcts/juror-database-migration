...
CREATE OR REPLACE FUNCTION JUROR.restrict_court (p_schema text, p_object text) RETURNS varchar AS $body$
BEGIN
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION JUROR.restrict_court (p_schema text, p_object text) FROM PUBLIC;
