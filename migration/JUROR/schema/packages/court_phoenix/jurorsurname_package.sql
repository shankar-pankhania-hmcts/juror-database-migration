 ...
 ************************************************************************/
CREATE OR REPLACE FUNCTION court_phoenix_jurorSurname ( name_in text ) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION court_phoenix_jurorSurname ( name_in text ) FROM PUBLIC;
