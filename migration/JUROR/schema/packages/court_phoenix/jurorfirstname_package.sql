...
/************************************************************************
 *	FUNCTION:	court_phoenix_jurorFirstName( name_in VARCHAR2 )
 *	Access  :	private
 ...
 ************************************************************************/
CREATE OR REPLACE FUNCTION court_phoenix_jurorFirstName ( name_in text ) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION court_phoenix_jurorFirstName ( name_in text ) FROM PUBLIC;
