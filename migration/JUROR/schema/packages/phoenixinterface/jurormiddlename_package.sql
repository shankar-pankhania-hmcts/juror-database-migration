...
/************************************************************************
 *	FUNCTION:	phoenixinterface_jurorMiddleName( name_in VARCHAR2 )
 *	Access  :	private
 ...
 *	V1.3    Kal Sohal 05/01/07 SCR 4341 SCR 4341 - Fixed phoenixinterface_jurorMiddleName() system test bug which returned the
 ...
 ************************************************************************/
CREATE OR REPLACE FUNCTION phoenixinterface_jurorMiddleName ( name_in text ) RETURNS varchar AS $body$
DECLARE
...
BEGIN
      ...
      s_name := phoenixinterface_jurorCleanName(s_name);  --Trac3897
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION phoenixinterface_jurorMiddleName ( name_in text ) FROM PUBLIC;
