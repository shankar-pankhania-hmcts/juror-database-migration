...
/************************************************************************
 *	FUNCTION:	phoenixinterface_jurorCleanName( name_in VARCHAR2 )
 *	Access  :	private
 ...
 ************************************************************************/
CREATE OR REPLACE FUNCTION phoenixinterface_jurorCleanName ( name_in text ) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON FUNCTION phoenixinterface_jurorCleanName ( name_in text ) FROM PUBLIC;
