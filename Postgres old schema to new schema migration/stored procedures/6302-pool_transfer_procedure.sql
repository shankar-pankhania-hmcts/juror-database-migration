...
begin
    ...
    loop
        ...
        exit when not found;
        call transfer_juror_pool(court_record.loc_code::varchar, latest_return_date::date);
        call transfer_pool(court_record.loc_code::varchar, latest_return_date::date);
    end loop;
    close courts_cursor;
end;
$$;